    ...
    <ContainerBezova>
      <div className="space-y-5">
        ...
        <p className="mx-auto max-w-xl">
          Současně s provedením testu nabízíme detekci netěsností. Netěsnosti je možno zjistit
          pomocí různých pomůcek. Kromě prvotního zjištění pomocí dlaně používáme detekci pomocí
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2">
          <div className="mt-10 flex flex-col items-center space-y-4">
            ...
            <p className="px-4">
              ...
              provedené k tomu speciálně určeným přístrojem Minneapolis DuctBlaster prověří kvalitu
              provedení Vašich vzduchotechnických rozvodů.
            </p>
          </div>
          <div className="mt-10 flex flex-col items-center space-y-4">
            <Image
