...
export default function BlowerDoor() {
  return (
    <ContainerBila>
      <h2 className="text-center text-zelena">Dotace na energetickou náročnost</h2>
      <div className="mx-auto mt-8 grid max-w-2xl grid-cols-2 gap-2">
        <div className="flex flex-col justify-center space-y-5 text-center">
          <p>V rámci Blower Door testu vám dodáme potřebný protokol k získání dotace.</p>
          <div>
            <Button href="/sluzby/blower-door-test">ZJISTIT VÍCE</Button>
          </div>
        </div>
