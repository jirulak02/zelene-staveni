			...
			{state.zatizeni && (
				<div className="space-y-3 pb-5">
					...
					<p>
						...
						mělo být počítáno min. 300 kg/m2 plošné hmotnosti dle
						navržené tloušťky substrátu. U extenzivních střech je
						zatížení cca 150 kg/m2 ve stavu nasycení vodou. Toto se
						týká při použití substrátu. Dnes lze použít i minerální
						rohože, které významně sníží zatížení na cca 50kg/m2. K
